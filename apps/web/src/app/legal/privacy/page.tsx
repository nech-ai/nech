		...
		<>
			...
			<div className="mb-8">
				<p>
					...
					we process when you join the Nech.ai waitlist (the "Waitlist"). This
			...
			<p>
				When you sign up for the Waitlist, we may collect the following personal
				data:
			</p>
			<ul>
				<li>
			...
			<ul>
				<li>
					<strong>Waitlist Management:</strong> To add you to the Waitlist,
					communicate updates, and notify you if and when you gain access to the
					beta version of Nech.ai.
				</li>
				<li>
				...
				<li>
					...
					information about Nech.ai, including promotional materials or
			...
			<ul>
				<li>
					...
					the Waitlist, you consent to our collection and processing of your
			...
			<ul>
				<li>
					...
					us in operating our website, running the Waitlist, or providing
			...
			<p>
				...
				request removal from the Waitlist, we will delete or anonymise your data
				as soon as practicable, unless legal obligations require us to retain
				it.
			</p>
			...
			<p>
				The Waitlist is not intended for individuals under the age of 18. We do
			...
			<p>
				...
				accordingly. By continuing to remain on the Waitlist after changes are
