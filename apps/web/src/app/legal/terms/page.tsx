	...
	return (
		<>
			...
			<p>
				...
				Nech.ai waitlist (the "Waitlist") organised by Comonad Limited (Company
				Number: 15713725) ("we", "us", "our"). By joining the Waitlist, you
				agree to be bound by these Terms.
			</p>

			<h2>2. Nature of the Waitlist</h2>
			<p>
				The Waitlist provides an opportunity for individuals and organisations
				to register their interest in accessing the beta version of Nech.ai (the
				"Service"). Joining the Waitlist does not guarantee access to the beta,
				nor does it create any obligation on our part to provide access at any
				time.
			</p>

			<h2>3. Changes and Modifications</h2>
			<p>
				We may update, modify, or discontinue any aspect of the Waitlist, these
				...
				to remain on the Waitlist or by accessing the Service after changes are
				made, you agree to be bound by the revised Terms.
			</p>

			<h2>4. Eligibility</h2>
			<p>
				Participation in the Waitlist is open to individuals aged 18 and above,
			...
			<p>
				...
				Waitlist. Any personal data submitted will be handled in accordance with
				our Privacy Policy. By joining the Waitlist, you consent to our
				collection and use of this data as described therein.
			</p>

			<h2>6. Intellectual Property</h2>
			<p>
				All rights, title, and interest in and to the Nech.ai platform,
				...
				and/or its licensors. Your participation in the Waitlist does not grant
				you any licence, right, or interest in our intellectual property.
			</p>

			<h2>7. No Warranty</h2>
			<p>
				Participation in the Waitlist and any eventual beta access to the
			...
			<p>
				...
				participation in the Waitlist or use of the Service, even if we have
				been advised of the possibility of such damages.
			</p>

			<h2>9. Termination</h2>
			<p>
				We may remove you from the Waitlist at any time, for any reason, or for
			...
			<p>
				...
				Limited concerning the Waitlist, and supersede all prior or
			...
			<div className="mt-8 border-t border-gray-800 pt-8">
				...
				<p className="mt-4 text-gray-400">
					By joining the Waitlist, you acknowledge that you have read,
