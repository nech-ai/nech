"use client";
import type { RoleFormValues, UpdateRoleFormValues } from "./types";
...
interface RoleFieldsProps {
	form: UseFormReturn<RoleFormValues | UpdateRoleFormValues>;
}

export function RoleFields({ form }: RoleFieldsProps) {
	return (
