...
import type { UpdateCredentialFormValues } from "@/actions/schema";
...
interface UpdateCredentialFieldsProps {
	form: UseFormReturn<UpdateCredentialFormValues>;
}

export function UpdateCredentialFields({ form }: UpdateCredentialFieldsProps) {
